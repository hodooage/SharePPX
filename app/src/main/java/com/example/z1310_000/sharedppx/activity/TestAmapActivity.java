...
import com.example.z1310_000.sharedppx.overlay.PoiOverlay;
import com.example.z1310_000.sharedppx.R;

public class TestAmapActivity extends AppCompatActivity implements PoiSearch.OnPoiSearchListener{
    ...
    private void doPOISearch() {
        PoiSearch.Query query = new PoiSearch.Query("路","110101","北京");
...
//    }
        ...
        if (errorCode == 1000) {
            if (poiResult != null && poiResult.getQuery() != null) {
                ...
                if (poiItems != null && poiItems.size() > 0) {
                    ...
                    Toast.makeText(TestAmapActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(TestAmapActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
            }
    ...
    public class ViewPoiOverlay extends PoiOverlay {
        ...
        protected BitmapDescriptor getBitmapDescriptor(int index) {
            View view = null;
            view = View.inflate(TestAmapActivity.this, R.layout.custom_view, null);
            TextView textView = ((TextView) view.findViewById(R.id.title));
    ...
    public static void startAction(Context context){
        Intent intent=new Intent(context,TestAmapActivity.class);
